...
├── 📄 Informe_Avance_v1_ICFES.docx    # Informe de avance y transición v1 → v2
│
├── data/
...
│   ├── sisben/                        # Dataset SISBÉN personas 12-17 años
│   └── men/                           # Dataset MEN estadísticas por municipio
│
└── README.md
```
...
- SISBÉN personas filtrado 12–17 años (913 registros totales)
...
| `estu_nse_establecimiento` | NSE promedio del colegio (1–4) | 🟠 Alto |
...
El accuracy estándar penaliza igual un error de 1 nivel (Bajo→Medio) que uno de 2 niveles (Bajo→Alto). Para clases ordinales esto es incorrecto. La **accuracy adyacente** cuenta como acierto cualquier predicción a distancia ≤ 1 del valor real, siendo más honesta para este tipo de problema.

### Análisis de errores (mejor modelo v1 — Test 2022):
```
Total estudiantes evaluados:  7,409
  Exactamente correctos:      3,464  (46.8%)  ✅
  Error de 1 nivel:           2,956  (39.9%)  ⚠️  (adyacente — tolerable)
...
2. Entendimiento de los datos  → Entrega 1, Secciones 3–5
...
| Nombre | Rol |
|--------|-----|
| Juan Santiago Méndez | Análisis de datos y modelado |
| Juan Martín Trejos | Feature engineering y evaluación |
| Diego Zabala | Pipeline de datos y arquitectura |
| Juan David Ordoñez | EDA y visualizaciones |
